function [NI_session,Arduino_Serial]=configure_NI_and_Arduino_temp(handles)
...
if  strcmp(handles.computername,'PRIYANKA-PC')
    DAQchannels = addAnalogInputChannel(NI_session,'Dev2',{'ai0','ai1','ai2','ai3','ai4','ai5','ai6','ai7','ai8'},'Voltage');
end
% configure all analog channels as single ended and voltage range [-5 to 5]
for i = 1:handles.NIchannels
