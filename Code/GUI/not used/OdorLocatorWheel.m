function varargout = OdorLocatorWheel(varargin)

% ODORLOCATORWHEEL MATLAB code for OdorLocatorWheel.fig (GUI)
%      ODORLOCATORWHEEL, by itself, creates a new ODORLOCATORWHEEL or raises the existing
%      singleton*.
%
%      H = ODORLOCATORWHEEL returns the handle to a new ODORLOCATORWHEEL or the handle to
%      the existing singleton*.
%zeros
%      ODORLOCATORWHEEL('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ODORLOCATORWHEEL.M with the given input arguments.
%
%      ODORLOCATORWHEEL('Property','Value',...) creates a new ODORLOCATORWHEEL or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before OdorLocatorWheel_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to OdorLocatorWheel_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help OdorLocatorWheel

<<<<<<< HEAD:Code/GUI/OdorLocator.m
% Last Modified by GUIDE v2.5 21-Jan-2017 18:36:55
=======
% Last Modified by GUIDE v2.5 20-Sep-2017 15:12:45
>>>>>>> Smellocator:Code/GUI/not used/OdorLocatorWheel.m

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @OdorLocatorWheel_OpeningFcn, ...
                   'gui_OutputFcn',  @OdorLocatorWheel_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before OdorLocatorWheel is made visible.
function OdorLocatorWheel_OpeningFcn(hObject, eventdata, handles, varargin)
% basic housekeeping
...
function varargout = OdorLocatorWheel_OutputFcn(hObject, eventdata, handles)  %#ok<*INUSL>
...
if usrans == 1
    ...
    session_data.ForNextSession = [handles.RewardControls.Data(3) handles.TFLeftprobability.Data(1)];
    session_data.ForNextSession_Legends = {'RewardHold-II', 'LeftvsRightTFs' };
