...
h.current_trial_block.Data(6) = handles.TrialSequence(h.current_trial_block.Data(2),2); % which odor
h.current_trial_block.Data(7) = handles.TrialSequence(h.current_trial_block.Data(2),1); % which location

%% invoke target definition callback (this automatically calls Update_Params)
set(h.motor_home,'BackgroundColor',[0.94 0.94 0.94]);
guidata(h.hObject, h);
OdorLocator('Update_Callback',h.hObject,[],h);
