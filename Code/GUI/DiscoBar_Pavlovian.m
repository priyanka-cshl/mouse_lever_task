function varargout = DiscoBar_Pavlovian(varargin)

% DISCOBAR_PAVLOVIAN MATLAB code for DiscoBar_Pavlovian.fig (GUI)
%      DISCOBAR_PAVLOVIAN, by itself, creates a new DISCOBAR_PAVLOVIAN or raises the existing
%      singleton*.
%
%      H = DISCOBAR_PAVLOVIAN returns the handle to a new DISCOBAR_PAVLOVIAN or the handle to
%      the existing singleton*.
%zeros
%      DISCOBAR_PAVLOVIAN('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DISCOBAR_PAVLOVIAN.M with the given input arguments.
%
%      DISCOBAR_PAVLOVIAN('Property','Value',...) creates a new DISCOBAR_PAVLOVIAN or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before DiscoBar_Pavlovian_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to DiscoBar_Pavlovian_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help DiscoBar_Pavlovian

% Last Modified by GUIDE v2.5 03-May-2023 09:40:30

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @DiscoBar_Pavlovian_OpeningFcn, ...
                   'gui_OutputFcn',  @DiscoBar_Pavlovian_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before DiscoBar_Pavlovian is made visible.
function DiscoBar_Pavlovian_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = DiscoBar_Pavlovian_OutputFcn(hObject, eventdata, handles)  %#ok<*INUSL>
