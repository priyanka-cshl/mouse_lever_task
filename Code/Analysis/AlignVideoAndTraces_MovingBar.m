...
handles.lim1 = line(min(handles.H4.XLim)+[0 0],get(gca,'YLim'),'color','k','Linewidth',6);
handles.lim2 = line(max(handles.H4.XLim)+[0 0],get(gca,'YLim'),'color','k','Linewidth',6);
...
for num = startindex:1:stopindex
    ...
    % display frames and corresponding time-series data
    if num == startindex
        startframe = frames_remaining + 1;
    else
        startframe = 1;
    end
