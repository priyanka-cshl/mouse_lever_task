  ...
  switch (_openlooptrialstate)
  {
    ...
    case 4: // deliver odor
      if (_time_since_last_change >= _odor_duration)
      {
        ...
        {
          _openlooptrialstate = 6; // switch to no flow directly
        }
      }
      break;
    ...
    case 3: // deliver clean air - II
      ...
      break;  
    case 6: // buffer state to just roll back the new odor location state when doing pseudorandom trains
      if (_time_since_last_change >= _motor_settle_duration)
      {
        _openlooptrialstate = 4; // back to odor
      }
      break;
    case 5: // ITI
