...
for whichodor = 1:4
    ...
    if ~isempty(whichtrials)
        ...
        for trial = 1:numel(whichtrials)
            ...
            if trial < div_line
                plot(time_idx,lever,'color','r');
            else
                plot(time_idx,lever,'color','k');
            end
        ...
        hold on
        plot(xbins, conv_psth(1,:), 'r', 'LineWidth', 1);
        plot(xbins, conv_psth(2,:), 'k', 'LineWidth', 1);
        ...
        hold on
        plot(xbins, conv_psth2(1,:), 'r', 'LineWidth', 1);
        plot(xbins, conv_psth2(2,:), 'k', 'LineWidth', 1);
