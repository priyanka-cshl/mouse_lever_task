...
function [] = PlotReplay(Traces, TrialInfo, TargetZones, Replay, SingleUnits, whichUnits)
global SampleRate;
global MyFileName;

saveas(gcf,[MyFileName,'_AllBehavior.fig']);
...
for i = 1:trials_per_replay
    ...
    Rewards = Replay.ReplayTraces{whichreplay,i}(:,7);
